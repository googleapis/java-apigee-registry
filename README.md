...
The Maven artifact coordinates (`com.google.cloud:google-cloud-apigee-registry`) remain the same.
...
```Groovy
implementation 'com.google.cloud:google-cloud-apigee-registry:0.10.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-apigee-registry" % "0.10.0"
```
